    ...
    return {
      designDirections: [
        ...
        },
        {
          id: "warm-human",
          name: "温暖人文",
          description: "暖色调、圆润造型，传递亲和力和信任感",
          palette: ["#FFFBEB", "#F59E0B", "#92400E", "#1C1917", "#D6D3D1"],
          colorStrategy: "Committed",
          typography: { display: "Noto Serif SC", body: "Noto Sans SC" },
          register: "brand",
          visualCharacteristics: ["温暖", "人文", "亲和", "可信"],
        },
      ],
      suggestions: [
        {
